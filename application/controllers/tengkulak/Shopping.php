...
class Shopping extends CI_Controller {
	...
	public function index()
	{
		...
		$data['harga'] = $this->keranjang_model->get_produk_kategori($kategori);
		$data['categori'] = $this->keranjang_model->get_kategori_all();
	...
	public function tampil_cart()
	{
		$data['categori'] = $this->keranjang_model->get_kategori_all();
		// $this->load->view('themes/header',$data);
		$this->load->view('tengkulak/tampil_cart',$data);
		// $this->load->view('themes/footer');
	}
