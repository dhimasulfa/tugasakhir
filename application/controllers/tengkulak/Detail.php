...
class Detail extends CI_Controller {
    ...
    {
        $data["list"] = $this->tengkulak_model->getAll('barang','harga');
        // $data["list"] = $this->tengkulak_model->tablejoin2('barang b','harga h', 'b.brg_id=h.brg_id');
        $this->load->view("tengkulak/detail", $data);
    }
