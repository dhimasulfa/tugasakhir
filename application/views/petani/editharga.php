			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('petani/harga/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" petani/harga/edit") ?>" method="post"
							enctype="multipart/form-data" >

							<input type="hidden" name="id" value="<?php echo $product->hrg_id?>" />
							...
							<div class="form-group">
								...
								echo "<option value='".$row->brg_id."'>".$row->ctg_id."</option>";
								}
								?>
								</select>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
								 type="number" name="price" placeholder="Harga Produk" value="<?php echo $product->hrg_nilai ?>" />
